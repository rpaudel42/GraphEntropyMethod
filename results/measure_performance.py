import math
from properties import Experiment as gs, GraphEntropy as ge
from pylab import *
import datetime
...
class MeasurePerformance:
    ...
    def calculate_metrics(self, detected_drift_points, false_alarm, dataset):
        #dd.PEDrift = [1020, 2030, 4025, 5018]
        #dd.FA = [878, 1340, 1876, 2530,2890,3589, 4678, 5800]
        results = {}
    ...
    def print_sumary(self, summary, dataset, param_n, param_w):
        file_name = dataset.dataset_name+'_results.txt'

        result_text = '\n\n\n ------ Final Result  [ '+dataset.dataset_name + ' -- param[ n = '+ str(param_n) + ', w = ' + str(param_w) +'] ]-----\n'
